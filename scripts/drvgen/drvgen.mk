...
ifeq ($(strip $(CONFIG_ARM64)), y)
ifneq ($(wildcard $(shell pwd)/$(objtree)/arch/$(SRCARCH)/boot/dts/dtsFileList.txt),)
CONFIG_BUILD_ARM64_DTB_OVERLAY_IMAGE_NAMES := $(file <$(shell pwd)/$(objtree)/arch/$(SRCARCH)/boot/dts/dtsFileList.txt)
endif
...
-include $(srctree)/scripts/drvgen/lcdkit.mk
endif
