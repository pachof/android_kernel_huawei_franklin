...
#define PROTECT_MEMCG_MAX	PROTECT_LEVELS_MAX
...
extern unsigned long protect_max_mbytes[];
extern unsigned long protect_cur_mbytes[];
extern int protect_reclaim_ratio_handler(struct ctl_table *table, int write,
			void __user *buffer, size_t *length, loff_t *ppos);
extern int protect_cur_pages_handler(void);
extern int protect_max_mbytes_handler(struct ctl_table *table, int write,
		void __user *buffer, size_t *length, loff_t *ppos);
extern int protect_cur_mbytes_handler(struct ctl_table *table, int write,
		void __user *buffer, size_t *length, loff_t *ppos);
