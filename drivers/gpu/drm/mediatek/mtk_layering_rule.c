...
static void filter_by_yuv_layers(struct drm_mtk_layering_info *disp_info)
{
	...
	struct drm_mtk_layer_config *info = NULL;
...
{
	struct drm_mtk_layer_config *c, *tmp_c = NULL;
...
{
	int i = 0, ext_id = 0;
	struct drm_mtk_layer_config *c = NULL, *ext_c = NULL;
...
{
	int i = 0;
	struct drm_mtk_layer_config *layer_info_s = NULL, *layer_info_d = NULL;
