...
#if ((defined CONFIG_HUAWEI_SENSORS) || (defined CONFIG_HUAWEI_SENSORS_2_0))
	/* Use in-screen fingerprints on the mtk-6768 mtk-6853 and mtk-6873 platforms */
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	THP_LOG_INFO("%s: update status: %u\n", __func__, status);
