...
KERNEL_CONFIG_OVERRIDE += CONFIG_HW_MTK_RTG_SCHED_TRACE=n
KERNEL_CONFIG_OVERRIDE += CONFIG_MTK_RTG_SCHED_DEBUG=n
endif
...
PRODUCT_LIST := $(file <$(KERNEL_OUT)/arch/$(KERNEL_TARGET_ARCH)/boot/dts/productList.txt)
