...
#define BTSUSBNTC_RAP_PULL_UP_R		12000 /* 12K, pull up resister */
#define BTSUSBNTC_TAP_OVER_CRITICAL_LOW	188500 /* base on 10K NTC temp
						 * default value -40 deg
						 */
#define BTSUSBNTC_RAP_PULL_UP_VOLTAGE		1800 /* 1.8V ,pull up voltage */
#define BTSUSBNTC_RAP_NTC_TABLE		8
#define BTSUSBNTC_RAP_ADC_CHANNEL		AUX_IN5_NTC
