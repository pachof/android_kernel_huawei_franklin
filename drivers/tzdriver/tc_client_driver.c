...
int tc_ns_client_close(tc_ns_dev_file *dev)
{
	int ret = TEEC_ERROR_GENERIC;
	uint32_t index = 0;
...
static tc_ns_shared_mem *alloc_and_find_shared_mem(struct vm_area_struct *vma,
	tc_ns_dev_file *dev_file, bool *only_remap)
{
