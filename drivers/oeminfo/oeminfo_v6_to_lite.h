...
typedef enum {
    ...
    OEMINFO_NONEWP_REUSED_ID_555_8K_VALID_SIZE_128_BYTE = 555,
    OEMINFO_NONEWP_REUSED_ID_556_8K_VALID_SIZE_32_BYTE = 556,
    ...
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_00 = 725,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_01 = 726,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_02 = 727,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_03 = 728,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_04 = 729,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_05 = 730,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_06 = 731,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_07 = 732,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_08 = 733,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_09 = 734,
    OEMINFO_NONEWP_CGM_SCG_DATA = 735,
    OEMINFO_NONEWP_CGM_WCG_DATA = 736,
    ...
    OEMINFO_PWRUPWP_CASTHDCP = 1512,
    OEMINFO_PWRUPWP_MODSN_CHECK = 1513,
...
static struct OeminfoV6ToLite g_oeminfoLiteTable[] = {
    { /* ----------- */
        ...
        OEMINFO_NONEWP_REUSED_ID_555_8K_VALID_SIZE_128_BYTE
    }, { /* oeminfoid=211 */
        OEMINFO_REUSED_ID_211_8K_VALID_SIZE_32_BYTE,
        OEMINFO_NONEWP_REUSED_ID_556_8K_VALID_SIZE_32_BYTE
    }, { /* oeminfoid=212 */
        0,
        0
    }, { /* oeminfoid=213 */
