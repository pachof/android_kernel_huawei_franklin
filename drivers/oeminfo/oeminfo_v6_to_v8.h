...
typedef enum {
    ...
    OEMINFO_NONEWP_SCCAL_CUR = 124,
    OEMINFO_NONEWP_CUR_OFFSET = 125,
    OEMINFO_NONEWP_BAT_BLIMSW = 126,
    OEMINFO_NONEWP_BAT_BBINFO = 127,
    /* the id from 1000 to 1100 of 8k area are reserved */
    OEMINFO_NONEWP_REUSED_ID_1101_8K_VALID_SIZE_448_BYTE = 1101,
    OEMINFO_NONEWP_REUSED_ID_1102_8K_VALID_SIZE_64_BYTE = 1102,
    OEMINFO_NONEWP_FMD_VERIFY_DATA = 1103,
    OEMINFO_NONEWP_FCDEG = 1104,
    OEMINFO_NONEWP_REUSED_ID_1105_8K_VALID_SIZE_128_BYTE = 1105,
    OEMINFO_NONEWP_REUSED_ID_1106_8K_VALID_SIZE_32_BYTE = 1106,
    /* the id from 1400 to 1420 of 64k area are reserved */
    OEMINFO_NONEWP_WCNSS_FIR_BAK_TYPE = 1421,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION1_TYPE = 1422,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION2_TYPE = 1423,
    OEMINFO_NONEWP_FASTBOOT_FMD_DATA = 1424,
    OEMINFO_NONEWP_BASE_CLOUD_ROM_LIST = 1425,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION3_TYPE = 1427,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION4_TYPE = 1428,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION5_TYPE = 1429,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION6_TYPE = 1430,
    OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION7_TYPE = 1431,
    OEMINFO_NONEWP_CAMERA_BLC_CALIB = 1432,
    OEMINFO_NONEWP_SPECCALIB0 = 1433,
    OEMINFO_NONEWP_SPECCALIB1 = 1434,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_00 = 1435,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_01 = 1436,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_02 = 1437,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_03 = 1438,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_04 = 1439,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_05 = 1440,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_06 = 1441,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_07 = 1442,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_08 = 1443,
    OEMINFO_NONEWP_CAMERA_EEPROM_DATA_09 = 1444,
    OEMINFO_NONEWP_CGM_SCG_DATA = 1445,
    OEMINFO_NONEWP_CGM_WCG_DATA = 1446,
    /* the next id is used for oeminfo_v8 root-wp area */
    OEMINFO_ROOTWP_BOARD_CODE_TYPE = 1501,
    OEMINFO_ROOTWP_VENDER_AND_COUNTRY_NAME = 1502,
    OEMINFO_ROOTWP_IMEI2_NUM = 1503,
    OEMINFO_ROOTWP_FACT_INFO = 1504,
    OEMINFO_ROOTWP_HWSB_AES_PWD = 1505,
    OEMINFO_ROOTWP_SKU_TYPE = 1506,
    OEMINFO_ROOTWP_MANUFACTURE_DATE_TYPE = 1507,
    OEMINFO_ROOTWP_LGU_SPECIAL_SN = 1508,
    OEMINFO_ROOTWP_IMEI_TYPE = 1509,
    OEMINFO_ROOTWP_MEID_TYPE =1510,
    OEMINFO_ROOTWP_ESN_TYPE = 1511,
    OEMINFO_ROOTWP_BT_TYPE = 1512,
    OEMINFO_ROOTWP_WIFI_TYPE =1513,
    OEMINFO_ROOTWP_FACTORY_INFO_TYPE = 1514,
    OEMINFO_ROOTWP_BUILD_NUMBER_TYPE = 1516,
    OEMINFO_ROOTWP_SINGLE_SIM = 1517,
    OEMINFO_ROOTWP_PRODUCT_MODEL_TYPE = 1518,
    OEMINFO_ROOTWP_DEVICE_MODEL = 1519,
    OEMINFO_ROOTWP_FRP_OPEN_FLAG = 1520,
    OEMINFO_ROOTWP_FRP_KEY = 1521,
    OEMINFO_ROOTWP_PRODUCE_PHASE_FLAG = 1522,
    OEMINFO_ROOTWP_MMIAUTORUN = 1523,
    OEMINFO_ROOTWP_MMIAUTOCFG = 1524,
    OEMINFO_ROOTWP_RD_LOCK_STATE = 1525,
    OEMINFO_ROOTWP_ACCESS_LOCK_STATE = 1526,
    OEMINFO_ROOTWP_ACCESS_KEY = 1527,
    OEMINFO_ROOTWP_CONTROL_FLAG = 1528,
    OEMINFO_ROOTWP_QRCODE_INFO = 1529,
    OEMINFO_ROOTWP_LOG_SWITCH_TYPE = 1530,
    OEMINFO_ROOTWP_BASEBAND_VERSION_TYPE = 1531,
    OEMINFO_ROOTWP_CONTROL_BIT = 1532,
    OEMINFO_ROOTWP_UDID_CODE_TYPE = 1533,
    OEMINFO_ROOTWP_SYSDLL_INSTALL_TYPE = 1536,
    OEMINFO_ROOTWP_TOF_EYE_SAFE_TYPE = 1538,
    OEMINFO_ROOTWP_AUTH_ELABEL = 1539,

    /* the id from 2500 to 2600 of 8k area are reserved */
    OEMINFO_ROOTWP_DEVICE_CERTIFICATE1 = 2601,
    OEMINFO_ROOTWP_DEVICE_CERTIFICATE2 = 2602,
    OEMINFO_ROOTWP_KEY_ATTESTATION = 2603,

    /* the id from 2900 to 2920 of 64k area are reserved */
    OEMINFO_ROOTWP_NFC_SEID = 2921,
    OEMINFO_ROOTWP_SCREEN_DATA = 2922,

    /* the next id is used for oeminfo_v8 powerup-wp area */
    OEMINFO_PWRUPWP_SENSOR_PROXIMITY_PA2240_CALIBRATION = 3001,
    OEMINFO_PWRUPWP_OIS_GYROGAIN = 3002,
    OEMINFO_PWRUPWP_ACCEL_SENSOR_DATA = 3003,
    OEMINFO_PWRUPWP_CAP_PROX_DATA_INFO = 3004,
    OEMINFO_PWRUPWP_SENSOR_LIGHT_BH1745_CALIBRATION = 3005,
    OEMINFO_PWRUPWP_GYRO_SENSOR_DATA = 3006,
    OEMINFO_PWRUPWP_QRCODE_BSN = 3007,
    OEMINFO_PWRUPWP_CAMERA_LASERCALIB = 3008,
    OEMINFO_PWRUPWP_MOD_HASH = 3009,
    OEMINFO_PWRUPWP_TOF_EYE_SAFE_TYPE = 3010,
    OEMINFO_PWRUPWP_LANMAC = 3011,
    OEMINFO_PWRUPWP_CASTHDCP = 3012,
    OEMINFO_PWRUPWP_MODSN_CHECK = 3013,
    /* the id from 4000 to 4100 of 8k area are reserved */
    /* the id from 4400 to 4420 of 64k area are reserved */
    OEMINFO_PWRUPWP_CAMERA_HDC = 4421,
    OEMINFO_PWRUPWP_GMP = 4422,
    /* the next id is used for  oeminfo_v8 logo area */
    OEMINFO_NONEWP_ASCEND_TYPE = 4501,
    OEMINFO_NONEWP_LOW_POWER_TYPE = 4502,
    OEMINFO_NONEWP_POWER_CHARGING_TYPE = 4503,
} OeminfoTypeV8;
...
static struct OeminfoV6ToV8 g_oeminfoV8Table[] = {
    { /* ----------- */
        ...
        OEMINFO_SCCAL_CUR,
        OEMINFO_NONEWP_SCCAL_CUR
    }, { /* oeminfoid=62 */
        OEMINFO_CUR_OFFSET,
        OEMINFO_NONEWP_CUR_OFFSET
    }, { /* oeminfoid=63 */
        0,
        0
    }, { /* oeminfoid=64 */
        ...
        OEMINFO_NONEWP_REUSED_ID_1101_8K_VALID_SIZE_448_BYTE
    }, { /* oeminfoid=204 */
        OEMINFO_REUSED_ID_204_8K_VALID_SIZE_64_BYTE,
        OEMINFO_NONEWP_REUSED_ID_1102_8K_VALID_SIZE_64_BYTE
    }, { /* oeminfoid=205 */
        ...
        OEMINFO_REUSED_ID_210_8K_VALID_SIZE_128_BYTE,
        OEMINFO_NONEWP_REUSED_ID_1105_8K_VALID_SIZE_128_BYTE
    }, { /* oeminfoid=211 */
        OEMINFO_REUSED_ID_211_8K_VALID_SIZE_32_BYTE,
        OEMINFO_NONEWP_REUSED_ID_1106_8K_VALID_SIZE_32_BYTE
    }, { /* oeminfoid=212 */
        0,
        0
    }, { /* oeminfoid=213 */
        ...
        OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION5_TYPE
    }, { /* oeminfoid=308 */
        OEMINFO_CAMERA_TOF_CALIBRATION6_TYPE,
        OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION6_TYPE
    }, { /* oeminfoid=309 */
        OEMINFO_CAMERA_TOF_CALIBRATION7_TYPE,
        OEMINFO_NONEWP_CAMERA_TOF_CALIBRATION7_TYPE
    }, { /* oeminfoid=310 */
        ...
        OEMINFO_NONEWP_CGM_SCG_DATA
    }, { /* oeminfoid=314 */
        OEMINFO_CGM_WCG_DATA,
        OEMINFO_NONEWP_CGM_WCG_DATA
    }, { /* oeminfoid=315 */
        0,
        0
    }, { /* oeminfoid=316 */
        ...
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_00
    }, { /* oeminfoid=341 */
        OEMINFO_CAMERA_EEPROM_DATA_01,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_01
    }, { /* oeminfoid=342 */
        OEMINFO_CAMERA_EEPROM_DATA_02,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_02
    }, { /* oeminfoid=343 */
        OEMINFO_CAMERA_EEPROM_DATA_03,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_03
    }, { /* oeminfoid=344 */
        OEMINFO_CAMERA_EEPROM_DATA_04,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_04
    }, { /* oeminfoid=345 */
        OEMINFO_CAMERA_EEPROM_DATA_05,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_05
    }, { /* oeminfoid=346 */
        OEMINFO_CAMERA_EEPROM_DATA_06,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_06
    }, { /* oeminfoid=347 */
        OEMINFO_CAMERA_EEPROM_DATA_07,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_07
    }, { /* oeminfoid=348 */
        OEMINFO_CAMERA_EEPROM_DATA_08,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_08
    }, { /* oeminfoid=349 */
        OEMINFO_CAMERA_EEPROM_DATA_09,
        OEMINFO_NONEWP_CAMERA_EEPROM_DATA_09
    }, { /* oeminfoid=350 */
        0,
        0
    }, { /* oeminfoid=351 */
