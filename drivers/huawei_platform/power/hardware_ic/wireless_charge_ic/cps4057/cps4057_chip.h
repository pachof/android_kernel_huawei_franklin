...
#define CPS4057_TX_PLOSS_TH_ADDR              0x1E58
#define CPS4057_TX_PLOSS_TH_LEN               2
/* func_en register */
#define CPS4057_TX_FUNC_EN_ADDR               0x1E5E
#define CPS4057_TX_FUNC_EN_LEN                2
#define CPS7181_TX_FUNC_EN                    1
#define CPS7181_TX_FUNC_DIS                   0
...
#define CPS4057_TX_EPT_SRC_LEN                1
#define CPS4057_TX_EPT_SRC_WRONG_PKT          BIT(0)
#define CPS4057_TX_EPT_SRC_AC_DET             BIT(1)
#define CPS4057_TX_EPT_SRC_SSP                BIT(2)
#define CPS4057_TX_EPT_SRC_RX_EPT             BIT(3)
#define CPS4057_TX_EPT_SRC_CEP_TIMEOUT        BIT(4)
#define CPS4057_TX_EPT_SRC_OCP                BIT(6)
#define CPS4057_TX_EPT_SRC_OVP                BIT(7)
#define CPS4057_TX_EPT_SRC_UVP                BIT(8)
#define CPS4057_TX_EPT_SRC_FOD                BIT(9)
#define CPS4057_TX_EPT_SRC_OTP                BIT(10)
#define CPS4057_TX_EPT_SRC_POCP               BIT(11)
