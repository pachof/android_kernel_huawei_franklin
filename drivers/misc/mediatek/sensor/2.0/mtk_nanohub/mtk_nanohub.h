...
struct hw_fg_sense_event_t {
	uint32_t fg_data_ready;
	uint32_t fg_status;
	uint32_t fg_temp;
};

struct aod_motion_event_t {
	int32_t data[3];
};

struct hw_rpc_motion_event_t {
	int32_t data[3];
};
...
struct data_unit_t {
	...
	union {
		...
		struct hw_motion_event_t hw_motion_event;
		struct hw_fg_sense_event_t fg_sense_event;
		struct aod_motion_event_t aod_motion_event;
		struct hw_rpc_motion_event_t rpc_motion_event;
		int32_t data[8];
	};
} __packed;
