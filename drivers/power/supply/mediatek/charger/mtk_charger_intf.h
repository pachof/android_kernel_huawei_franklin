...
/* sw jeita */
#define JEITA_TEMP_DEFAULT_CURRENT_T0_T1 420000
#define JEITA_TEMP_DEFAULT_CURRENT_T1_T2 1400000
#define JEITA_TEMP_DEFAULT_CURRENT_T2_T3 2700000
#define JEITA_TEMP_DEFAULT_CURRENT_T3_T4 1620000
...
struct charger_custom_data {
	...
	int fcp_charger_current;
	int fcp_charger_input_current;
...
struct charger_manager {
	...
	/* short current detect information */
	...
	/* is support PD charge*/
	bool is_support_pd_chg;
};
