...
/* PQ */
#define C_TUN_IDX 25 /* COLOR_TUNING_INDEX */
#define COLOR_TUNING_INDEX 25
...
#define CCORR_COEF_CNT 14 /* ccorr feature */
...
/* RGBW */
#ifdef CONFIG_LCD_KIT_DRIVER
#define DRM_RGBW_MODE_SET_PARAM 0x40
#define DRM_RGBW_MODE_GET_PARAM 0x41
#define DRM_DISPLAY_ENGINE_INIT 0x42
#define DRM_DISPLAY_ENGINE_PANEL_INFO_GET 0x43

/* HBM */
#define DRM_HBM_MODE_SET_PARAM 0x44
#endif
...
#ifdef CONFIG_LCD_KIT_DRIVER
#define DRM_IOCTL_RGBW_MODE_SET_PARAM	DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_RGBW_MODE_SET_PARAM, struct display_engine_ddic_rgbw_param)

#define DRM_IOCTL_RGBW_MODE_GET_PARAM	DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_RGBW_MODE_GET_PARAM, struct display_engine_ddic_rgbw_param)

#define DRM_IOCTL_DISPLAY_ENGINE_PANEL_INFO_GET	DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_DISPLAY_ENGINE_PANEL_INFO_GET, \
			struct display_engine_panel_info_param)

#define DRM_IOCTL_DISPLAY_ENGINE_INIT	DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_DISPLAY_ENGINE_INIT, struct display_engine)

#define DRM_IOCTL_HBM_MODE_SET_PARAM	DRM_IOWR(DRM_COMMAND_BASE + \
		DRM_HBM_MODE_SET_PARAM, struct display_engine_ddic_hbm_param)
#endif
