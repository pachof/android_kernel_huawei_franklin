...
#define MSDC_NMC_NORMAL		(0)
#define MSDC_NMC_SUSPEND	(1)
#define MSDC_NMC_RUNTIME_SUSPEND	(2)
#endif
...
#endif
#ifdef CONFIG_MMC_DW_MUX_SDSIM
	struct rw_semaphore	suspend_rwsem;
#endif
...
/************************ +1 for merge ****************************************/
	...
	int mux_sdsim;
	/*
	 * if msdc_suspend is 1, runtime_suspend is 2
	 * resume and init is 0.
	 */
	int suspend_flag;
#endif
};
...
#ifdef CONFIG_MMC_DW_MUX_SDSIM
/* get card insert state */
int get_cd_state(struct msdc_host *host);
#endif
