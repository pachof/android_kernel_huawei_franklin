...
/*OV*/
UINT32 OV8856_FOXCONN_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV48B2Q_LUXVISIONS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02A10_SUNWIN_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV16A1Q_OFILM_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5K3P9_SUNNY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*HI*/
UINT32 HI846_OFILM_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI846_SUNNY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC2375_BYD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
