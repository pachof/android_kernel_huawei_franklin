...
struct direct_charge_batinfo_ops {
	...
	int (*get_vbus_voltage)(int *vol, void *);
	int (*get_bat_current)(int *cur, void *);
	int (*get_ic_ibus)(int *ibus, void *);
	int (*get_ic_temp)(int *temp, void *);
	int (*get_ic_vout)(int *vout, void *);
	int (*get_ic_vusb)(int *vusb, void *);
};
...
int dc_set_ic_buck_enable(int mode, int type, int enable);
int dc_ic_reg_reset_and_init(int mode, int type);
...
int dc_get_bat_max_btb_voltage_witc_comp(int mode, int type, const int *vbat_comp);
int dc_get_vbus_voltage(int mode, int type, int *vbus);
int dc_get_bat_current(int mode, int type, int *ibat);
void dc_get_bat_current_with_comp(int *value);
...
#else
static inline int dc_sc_ops_register(unsigned int type,
	struct direct_charge_ic_ops *ops)
{
	return -1;
}
...
static inline int dc_batinfo_ops_register(int mode, unsigned int type,
	struct direct_charge_batinfo_ops *ops)
{
	return -1;
}
...
static inline int dc_set_ic_buck_enable(int mode, int type, int enable)
{
	return -1;
}

static inline int dc_ic_reg_reset_and_init(int mode, int type)
{
	return -1;
}
...
static inline int dc_get_bat_max_btb_voltage_witc_comp(int mode, int type, const int *vbat_comp)
{
	return -1;
}
...
static inline void dc_get_bat_current_with_comp(int *value)
{
}
