...
#define ST88_WAIT_FOR_ACK_SLEEP_TIME       100
#define ST88_WAIT_FOR_ACK_RETRY_CNT        5
...
struct stwlc88_dev_info {
	...
	bool irq_active;
	u8 rx_fod_5v[ST88_RX_FOD_LEN];
	u8 rx_fod_9v[ST88_RX_FOD_LEN];
	u8 rx_fod_12v[ST88_RX_FOD_LEN];
	u8 rx_fod_15v[ST88_RX_FOD_LEN];
