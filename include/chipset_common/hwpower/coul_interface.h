...
enum coul_interface_event {
	COUL_EVENT_LOW_VOL = 0,
};
...
static inline int coul_interface_event_notifier_register(struct notifier_block *nb)
{
	return -EPERM;
}

static inline int coul_interface_event_notifier_unregister(struct notifier_block *nb)
{
	return -EPERM;
}

static inline int coul_interface_get_battery_last_capacity(int)
{
        return -EPERM;
}
...
static inline void coul_interface_event_notify(unsigned long event, void *data)
{
}
