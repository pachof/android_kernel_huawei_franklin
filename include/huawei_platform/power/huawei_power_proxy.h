...
#ifndef _HUAWEI_POWER_PROXY_H_
#define _HUAWEI_POWER_PROXY_H_
...
void power_proxy_sync_filter_soc(int rep_soc,
	int round_soc);
...
#else
static inline int power_proxy_get_filter_sum(void)
{
...
static inline int power_proxy_set_vterm_dec(int value)
{
	return 0;
}
