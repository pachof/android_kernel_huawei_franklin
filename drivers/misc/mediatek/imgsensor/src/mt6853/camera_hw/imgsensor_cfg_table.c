...
struct IMGSENSOR_HW_CFG imgsensor_wn_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD1_EN, IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DVDD_EN,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DVDD_SEL,  IMGSENSOR_HW_ID_GPIO},
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_1,
		{
			{IMGSENSOR_HW_PIN_MCLK,  IMGSENSOR_HW_ID_MCLK},
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_AVDD_EN,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_AVDD_SEL,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DVDD_EN,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DVDD_SEL,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
...
struct IMGSENSOR_HW_CFG imgsensor_frl_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_4,
		{
			...
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_RST1,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE},
		},
	},
	{
...
struct IMGSENSOR_HW_CFG imgsensor_jsc_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_cdy_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
struct IMGSENSOR_HW_CFG imgsensor_tsh_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_DVDD_EN,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DVDD_SEL,  IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_AFVDD_EN, IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_NONE,  IMGSENSOR_HW_ID_NONE},
		},
...
const product_custom_cfg_map g_product_cfg_map[] = {
	{ "Wukong", &imgsensor_wn_config[0] }, // for default
	{ "WukongV3", &imgsensor_wn_config[0] },
	{ "Frl", &imgsensor_frl_config[0] },
	{ "Cindy", &imgsensor_cdy_config[0] },
	{ "Jessica", &imgsensor_jsc_config[0] },
	{ "Tianshanb", &imgsensor_tsh_config[0] },
};

void get_imgsensor_custom_conf(const char *product_name)
{
	unsigned int size;
	unsigned int i;
	if (!product_name) {
		imgsensor_custom_config = g_product_cfg_map[0].custom_config;
		return;
	}
	size = sizeof(g_product_cfg_map) / sizeof(g_product_cfg_map[0]);
	for (i = 0; i < size; ++i) {
		if (!strcmp(product_name, g_product_cfg_map[i].product_name)) {
			imgsensor_custom_config = g_product_cfg_map[i].custom_config;
			PK_DBG("imgsensor custom config get %s", product_name);
			break;
		}
	}
	if (i == size) {
		imgsensor_custom_config = g_product_cfg_map[0].custom_config; // index 0 as default
		PK_PR_ERR("imgsensor custom config product not match, set %s as default",
			g_product_cfg_map[0].product_name);
	}
}
