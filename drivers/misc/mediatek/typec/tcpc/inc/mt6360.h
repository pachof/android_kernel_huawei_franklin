...
#define MT6360_REG_CC_CTRL2				(0xDC)
 ...
 */
#define MT6360_M_VBUS_TO_CC2			BIT(7)
#define MT6360_M_VBUS_TO_CC1			BIT(6)
#define MT6360_M_CTD				BIT(4)
#define MT6360_M_VBUS_TO_CC \
	(MT6360_M_VBUS_TO_CC2 | MT6360_M_VBUS_TO_CC1)
/*
...
/*
 * MT6360_REG_CC_CTRL2			(0xDC)
 */
#define MT6360_CMPEN_VBUS_TO_CC2		BIT(7)
#define MT6360_CMPEN_VBUS_TO_CC1		BIT(6)
#define MT6360_CMPEN_VBUS_TO_CC \
	(MT6360_CMPEN_VBUS_TO_CC2 | MT6360_CMPEN_VBUS_TO_CC1)
