...
#define AFDRV_DW9738AF "DW9738AF"
...
#define AFDRV_CN3928AF "CN3928AF"
#define AFDRV_GT9764AF "GT9764AF"
#define AFDRV_FP5516AF "FP5516AF"
#define AFDRV_CN3938AF "CN3938AF"
#define AFDRV_GT9764BAAF "GT9764BAAF"
...
#define loge_if_ret(x) do { \
	if ((x) < 0) {\
		pr_err("'%s' failed\n", #x); \
		return -1; \
	} \
} while (0)
#define return_error_on_null(x) do { \
	if ((x) == NULL) { \
		pr_err("%s invalid params %s\n", __func__, #x); \
		return -EINVAL; \
	} \
} while (0)
