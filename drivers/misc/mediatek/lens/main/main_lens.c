...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{ 1, AFDRV_CN3928AF, CN3928AF_SetI2Cclient, CN3928AF_Ioctl,
	 CN3928AF_Release, CN3928AF_GetFileName, NULL },
	{ 1, AFDRV_GT9764AF, GT9764AF_SetI2Cclient, GT9764AF_Ioctl,
	 GT9764AF_Release, GT9764AF_GetFileName, NULL },
	{ 1, AFDRV_FP5516AF, fp5516af_set_i2c_client, fp5516af_ioctl,
		fp5516af_release, fp5516af_get_file_name, NULL },
	{ 1, AFDRV_DW9738AF, dw9738af_set_i2c_client, dw9738af_ioctl,
		dw9738af_release, dw9738af_get_file_name, NULL },
	{ 1, AFDRV_CN3938AF, cn3938af_set_i2c_client, cn3938af_ioctl,
		cn3938af_release, cn3938af_get_file_name, NULL },
	{ 1, AFDRV_GT9764BAAF, gt9764baaf_set_i2c_client, gt9764baaf_ioctl,
		gt9764baaf_release, gt9764baaf_get_file_name, NULL },
	{ 1, AFDRV_CN3927AF, cn3927af_set_i2c_client, cn3927af_ioctl,
		cn3927af_release, cn3927af_get_file_name, NULL },
};
	...
	case AFIOC_G_OISPOSINFO:
		if (g_pstAF_CurDrv) {
			if (g_pstAF_CurDrv->pAF_OisGetHallPos) {
				...
				g_OisPosIdx = 0;
				g_GetOisInfoCnt = 100;
				rc = memset_s(&OisPosInfo, sizeof(OisPosInfo), 0, sizeof(OisPosInfo));
				if (rc != EOK)
					LOG_INF("memset_s OisPosInfo fail, rc = %d\n", rc);
				mutex_unlock(&ois_mutex);
