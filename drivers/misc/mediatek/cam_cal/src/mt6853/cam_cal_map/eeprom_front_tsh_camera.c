 ...
 * Description: eeprom front tsh camera
 * Author: mazhaung
 * Create: 2020-08-01
 */

#include "eeprom_front_tsh_camera.h"

// wn project front camera otp
static struct eeprom_hw_i2c_reg tsh_eeprom_map[] = {
	{ 0x00, EEPROM_I2C_WORD_ADDR, 1938,
...
int eeprom_front_tsh_camera_get_map(unsigned int sensor_id,
