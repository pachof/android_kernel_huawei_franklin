...
#include <chipset_common/hwpower/wireless_protocol_qi.h>
...
static int qi_protocol_handle_ask_packet_cmd_0x0e(u8 *data)
{
	...
	qi_protocol_send_fsk_msg(QI_CMD_ACK, &data[QI_ASK_PACKET_DAT3], 0,
		WIRELESS_RETRY_THREE);
	lightstrap_event_notify(LIGHTSTRAP_EVENT_GET_PRODUCT_TYPE,
		&data[QI_ASK_PACKET_DAT3]);
